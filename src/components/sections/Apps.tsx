    ...
    <section id="apps" ref={ref as React.RefObject<HTMLElement>} className="py-28 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className={clsx('text-center mb-14 reveal', inView && 'visible')}>
          <p className="text-brand text-sm font-semibold tracking-widest uppercase mb-4">Featured App</p>
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-4">
            What I've <span className="text-gradient">Built</span>
          </h2>
          <p className="text-slate-400 text-lg max-w-xl mx-auto">
            A real product crafted with care — try it and see for yourself.
          </p>
        </div>

        {/* Featured card */}
        <div className={clsx('glass rounded-3xl overflow-hidden reveal', inView && 'visible reveal-delay-2')}>
          ...
          <div className="p-8 sm:p-10 grid sm:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <div className="mt-8 p-4 rounded-2xl bg-brand/8 border border-brand/20">
                <p className="text-sm text-brand-light font-medium mb-1">Free & open to everyone</p>
                <p className="text-xs text-slate-400 leading-relaxed">
                  Organizers sign up free. Registrants join events with a QR code — no account needed.
                </p>
                <a
                  href={app.ctaHref}
                  target="_blank"
